...
<figure><img src="https://miro.medium.com/v2/resize:fit:700/1*TZJz2FxZMyJFtuWDo8qQAw.png" alt="" height="406" width="700"><figcaption></figcaption></figure>
...
#### Prerequisites: <a href="#f0cb" id="f0cb"></a>
...
You can also check my YouTube video:

### Importance of Monitoring: <a href="#id-7a5e" id="id-7a5e"></a>

Monitoring helps you understand what is happening in your application. Monitoring gives us the following advantages:

#### Analyzing long-term trends <a href="#d053" id="d053"></a>
...
#### Comparing over time or experiment groups <a href="#ee33" id="ee33"></a>
...
#### Alerting <a href="#b8fb" id="b8fb"></a>
...
#### Conducting _**ad hoc**_ retrospective analysis <a href="#id-6b77" id="id-6b77"></a>

Let’s say the performance of your system drops, you need to know what else happened around the same time.

### The Four Golden Signals <a href="#id-902a" id="id-902a"></a>
...
#### Latency <a href="#id-59ba" id="id-59ba"></a>
...
#### Traffic <a href="#id-76a2" id="id-76a2"></a>
...
#### Errors <a href="#id-801e" id="id-801e"></a>
...
#### Saturation <a href="#a05d" id="a05d"></a>
...
### Prometheus: A Robust Monitoring and Alerting Toolkit <a href="#id-48c5" id="id-48c5"></a>
...
#### Components of Prometheus: <a href="#id-3a07" id="id-3a07"></a>
...
#### Architecture of Prometheus: <a href="#e4ba" id="e4ba"></a>

This diagram illustrates the architecture of Prometheus and some of its ecosystem components:

Press enter or click to view image in full size

<figure><img src="https://miro.medium.com/v2/resize:fit:700/1*Ktoezmb8yB1wTCukb53X0w.png" alt="" height="421" width="700"><figcaption></figcaption></figure>

### Grafana: The Visualization Powerhouse <a href="#id-355e" id="id-355e"></a>
...
#### Key Features of Grafana: <a href="#id-567b" id="id-567b"></a>
...
#### How to setup Prometheus and Grafana: <a href="#id-1d85" id="id-1d85"></a>
...
<figure><img src="https://miro.medium.com/v2/resize:fit:700/1*kemszpp5WDg8fQxm4ifk2g.png" alt="" height="564" width="700"><figcaption></figcaption></figure>
...
#### 1. NodeJS application: <a href="#id-8185" id="id-8185"></a>
...
#### Traefik Integration: <a href="#id-18a1" id="id-18a1"></a>
...
#### [3. Node Exporter:](https://prometheus.io/docs/guides/node-exporter/) <a href="#id-12c1" id="id-12c1"></a>
...
#### [4. cAdvisor:](https://github.com/google/cadvisor) <a href="#id-58e8" id="id-58e8"></a>
...
#### **5. Prometheus:** <a href="#id-2212" id="id-2212"></a>
...
#### 6. Grafana: <a href="#id-88f6" id="id-88f6"></a>
...
<figure><img src="https://miro.medium.com/v2/resize:fit:700/1*8l9mqpjxRqDewq7c_mEr7w.png" alt="" height="498" width="700"><figcaption><p>cAdvisor dashboard</p></figcaption></figure>
...
<figure><img src="https://miro.medium.com/v2/resize:fit:700/1*JpiBIaXLdpq5D6muKpzH1g.png" alt="" height="314" width="700"><figcaption><p>Metrics from Traefik</p></figcaption></figure>
...
<figure><img src="https://miro.medium.com/v2/resize:fit:700/1*_KZVmtMJBuNAUKuTcBIX8g.png" alt="" height="314" width="700"><figcaption><p>Prometheus query explorer</p></figcaption></figure>
...
<figure><img src="https://miro.medium.com/v2/resize:fit:700/1*PrEEqZdn5sJSdBlymacYzw.png" alt="" height="314" width="700"><figcaption><p>graph</p></figcaption></figure>

### Creating dashboards in Grafana: <a href="#id-334a" id="id-334a"></a>
...
<figure><img src="https://miro.medium.com/v2/resize:fit:700/1*iD9Hu5jjYX5b3eoErz-C-w.png" alt="" height="314" width="700"><figcaption></figcaption></figure>
...
#### Checking the Prometheus Datasource: <a href="#id-631e" id="id-631e"></a>

Let’s check whether the Prometheus data source we configured is visible in Grafana. Click on data sources from the menu

Press enter or click to view image in full size

<figure><img src="https://miro.medium.com/v2/resize:fit:700/1*ql3lwW6_Q0WiKSjCTILMdw.png" alt="" height="314" width="700"><figcaption><p>click on data sources from the menu</p></figcaption></figure>

In the table you should be able to see Prometheus already configured:

Press enter or click to view image in full size

<figure><img src="https://miro.medium.com/v2/resize:fit:700/1*DzswQrx3wCFNyu5AYdtUcw.png" alt="" height="314" width="700"><figcaption></figcaption></figure>

#### Creating a Dashboard for Node Exporter: <a href="#abd7" id="abd7"></a>
...
**Step 1:** Click on the Dashboards menu.

Press enter or click to view image in full size

<figure><img src="https://miro.medium.com/v2/resize:fit:700/1*FQ5DblBqcLhBkk3eakd0Uw.png" alt="" height="314" width="700"><figcaption></figcaption></figure>

**Step 2:** Click on Create dashboard

Press enter or click to view image in full size

<figure><img src="https://miro.medium.com/v2/resize:fit:700/1*tlzJqiBZOYd9IXlCjakBjw.png" alt="" height="314" width="700"><figcaption></figcaption></figure>

**Step 3:** Click on Import dashboard.

Press enter or click to view image in full size

<figure><img src="https://miro.medium.com/v2/resize:fit:700/1*O5yvaAU-DO_qwjcSwEjd5A.png" alt="" height="314" width="700"><figcaption></figcaption></figure>

**Step 4:** You can use this [link](https://grafana.com/grafana/dashboards/1860-node-exporter-full/) to get the node-exporter dashboard’s ID from Grafana’s website. Click on the copy ID button.

Press enter or click to view image in full size

<figure><img src="https://miro.medium.com/v2/resize:fit:700/1*EN5eAQn9tkn3hHNs4gSk2w.png" alt="" height="314" width="700"><figcaption></figcaption></figure>

**Step 5:** Go back to our Grafana Import dashboard page. Now paste the ID into the text box and click the Load button.

Press enter or click to view image in full size

<figure><img src="https://miro.medium.com/v2/resize:fit:700/1*IT-72Heg6ADx0nbOmVlDcQ.png" alt="" height="314" width="700"><figcaption></figcaption></figure>

**Step 6:** In the next screen you can give a name for your dashboard. Select Prometheus in the dropdown and click on the Import button.

Press enter or click to view image in full size

<figure><img src="https://miro.medium.com/v2/resize:fit:700/1*B7FpgZEtfrFfM-Da-uFC6g.png" alt="" height="314" width="700"><figcaption></figcaption></figure>

The node-exporter dashboard will look like the following:

Press enter or click to view image in full size

<figure><img src="https://miro.medium.com/v2/resize:fit:700/1*nV3eJk2_WUugTV6xXSvmQw.png" alt="" height="314" width="700"><figcaption><p>Node exporter</p></figcaption></figure>
...
#### Frequently asked questions: <a href="#id-8bd7" id="id-8bd7"></a>

**Do we need to run all these services in a single docker-compose file for it to work?**
...
**Can I add multiple targets in the Prometheus config for a job?**
...
**Are there other ways of running these services other than Docker?**
...
### Conclusion: <a href="#id-7f7e" id="id-7f7e"></a>

In conclusion, the combination of Prometheus and Grafana provides a comprehensive monitoring solution that is both powerful and flexible. By leveraging these tools, organizations can achieve greater visibility into their systems, proactively manage performance, and ensure the reliability of their applications and infrastructure.
